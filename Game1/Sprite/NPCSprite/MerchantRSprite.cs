...
{
    class MerchantRSprite : DownIdleLinkSprite
    {
        public MerchantRSprite()
        {
        }
        public override void Draw(SpriteBatch spriteBatch)
        {
            ...
            spriteBatch.Draw(Texture2DStorage.GetMerchantRSpriteSheet(), destinationRectangle, sourceRectangle, Color.White);
        }
    }
}
