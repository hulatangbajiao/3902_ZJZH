...
{
    class DownMovingRedGoriyaSprite : ISprite
    {
        private int currentFrame = 0;
        private int totalFrame = 10;
        private Rectangle destinationRectangle;
        public DownMovingRedGoriyaSprite()
        {
        }
        ...
        public  void Draw(SpriteBatch spriteBatch, Vector2 Position)
        {
            ...
            spriteBatch.Draw(Texture2DStorage.GetDownMovingRedGoriyaSpriteSheet(), destinationRectangle, sourceRectangle, Color.White);
