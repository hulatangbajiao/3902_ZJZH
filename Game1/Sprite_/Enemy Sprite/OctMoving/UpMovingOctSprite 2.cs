...
{
    class UpMovingOctSprite : UpMovingLinkSprite
    {
        private int currentFrame = 0;
        private int totalFrame = 10;

        public UpMovingOctSprite()
        {
        }
        public override void Draw(SpriteBatch spriteBatch)
        {
            ...
            spriteBatch.Draw(Texture2DStorage.GetUpMovingOctorokSpriteSheet(), destinationRectangle, sourceRectangle, Color.White);
        }
    }
}
