...
{
    class DownMovingOctSprite : DownMovingLinkSprite
    {
        private int currentFrame = 0;
        private int totalFrame = 10;

        public DownMovingOctSprite()
        {
        }
        ...
        public override void Draw(SpriteBatch spriteBatch)
        {
            ...
            spriteBatch.Draw(Texture2DStorage.GetDownMovingOctorokSpriteSheet(), destinationRectangle, sourceRectangle, Color.White);
