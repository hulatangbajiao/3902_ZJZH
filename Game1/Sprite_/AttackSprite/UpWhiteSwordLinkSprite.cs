...
namespace Game1
{
    public class UpWhiteSwordLinkSprite : ISprite
    {
        ...
        public UpWhiteSwordLinkSprite(MainStage game)
        {
            Link = game.Link;
        ...
        public void Draw(SpriteBatch spriteBatch, Vector2 Position)
        {
            ...
            spriteBatch.Draw(Texture2DStorage.GetUpWhiteSwordLinkSpriteSheet(), destinationRectangle, sourceRectangle, Color.White);//use Texture2DStorage class to load texture2D
