...
namespace Game1
{
    public class LeftWhiteSwordLinkSprite : ISprite
    {
        private int currentFrame = 0;
        private int totalFrame = 12;
        private ILink Link;
        private Rectangle destinationRectangle;
        public LeftWhiteSwordLinkSprite(MainStage game)
        {
            Link = game.Link;
        ...
        public void Draw(SpriteBatch spriteBatch, Vector2 Position)
        {
            ...
            spriteBatch.Draw(Texture2DStorage.GetLeftWhiteSwordLinkSpriteSheet(), destinationRectangle, sourceRectangle, Color.White);//use Texture2DStorage class to load texture2D
