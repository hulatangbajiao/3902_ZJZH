...
namespace Game1
{
    public class DownWhiteSwordLinkSprite : ISprite
    {
        private int currentFrame = 0;
        private int totalFrame = 12;
        private ILink Link;
        private Rectangle destinationRectangle;
        public DownWhiteSwordLinkSprite(MainStage game)
        {
            Link = game.Link;
        ...
        public void Draw(SpriteBatch spriteBatch, Vector2 Position)
        {
            ...
            spriteBatch.Draw(Texture2DStorage.GetDownWhiteSwordLinkSpriteSheet(), destinationRectangle, sourceRectangle, Color.White);//use Texture2DStorage class to load texture2D
