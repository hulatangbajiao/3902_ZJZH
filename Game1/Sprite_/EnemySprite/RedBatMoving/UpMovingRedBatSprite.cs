...
{
    class UpMovingRedBatSprite : ISprite
    {
        private int currentFrame = 0;
        private int totalFrame = 10;
        private Rectangle destinationRectangle;
        public UpMovingRedBatSprite()
        {
        }
        ...
        public void Draw(SpriteBatch spriteBatch, Vector2 Position)
        {
            ...
            spriteBatch.Draw(Texture2DStorage.GetUpMovingRedBatSpriteSheet(), destinationRectangle, sourceRectangle, Color.White);
        }
