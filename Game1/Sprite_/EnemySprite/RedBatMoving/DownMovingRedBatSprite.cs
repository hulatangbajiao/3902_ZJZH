...
{
    class DownMovingRedBatSprite : ISprite
    {
        private int currentFrame = 0;
        private int totalFrame = 10;
        private Rectangle destinationRectangle;
        public DownMovingRedBatSprite()
        {
        }
        ...
        public  void Draw(SpriteBatch spriteBatch, Vector2 Position)
        {
            ...
            spriteBatch.Draw(Texture2DStorage.GetDownMovingRedBatSpriteSheet(), destinationRectangle, sourceRectangle, Color.White);
