...
{
    class MerchantPSprite : DownIdleLinkSprite
    {
        public MerchantPSprite()
        {
        }
        public override void Draw(SpriteBatch spriteBatch)
        {
            ...
            spriteBatch.Draw(Texture2DStorage.GetMerchantPSpriteSheet(), destinationRectangle, sourceRectangle, Color.White);
        }
    }
}
